...
(function () {
  ...
  var REPLIES = {
    ...
    education:
      'Учусь на 2 курсе по специальности РПО (разработчик ПО) в колледже IT TOP ACADEMY. Прохожу курсы «FullStack-разработчик» в Яндекс Практикуме. Опыт в компаниях: Методика (fullstack, лендинги, бекенд), Клерк (фронтенд-инженер, интерактивы, тренажёры, инструменты для бухгалтеров).',
    about:
      'Александр — frontend-разработчик из Краснодара, 18 лет. Самоучка. Опыт работы: Методика — fullstack, лендинги, настройка связи с бекендом; Клерк — фронтенд-инженер, интерактивы и тренажёры для статей, инструменты для бухгалтеров. Открыт к удалёнке и релокации, мечтает вырасти до fullstack.',
    skills:
